...
class Movies(Base):
    ...
    age_rating = Column(Enum(AgeRatingEnum, name="age_rating_type"), nullable=True)  # Độ tuổi: P, C13, C16, C18
    ...
    status = Column(Enum(MovieStatusEnum, name="movie_status_type"), default=MovieStatusEnum.upcoming, server_default='upcoming')  # Trạng thái: upcoming, now_showing, ended
